		...
		<div class="stuffbox pods-export-code">
			...
			<div class="pods-manage-field">
				<div class="pods-field-option-group">
					...
					<div class="pods-pick-values pods-pick-checkbox pods-zebra clear">
						<ul>
							<?php
							$zebra = false;
							foreach ( $this->exportable_pods() as $this_pod ) {
								...
								<li class="pods-zebra-<?php echo $class; ?>">
									<?php echo PodsForm::field( $this_pod['name'], true, 'boolean', [ 'boolean_yes_label' => $this_pod['name'] . ( ! empty( $this_pod['label'] ) ? ' (' . $this_pod['label'] . ')' : '' ) ] ); ?>
								</li>
								<?php
							}
							?>
